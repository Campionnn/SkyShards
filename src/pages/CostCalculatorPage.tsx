...
import type { CalculationResult, CalculationParams } from "../types/types";
...
const CalculatorFormWithContext: React.FC<{ onSubmit: (data: CalculationFormData, setForm: (data: CalculationFormData) => void) => void }> = ({ onSubmit }) => {
  ...
  return <CostCalculatorForm onSubmit={(data) => onSubmit(data, setForm)} />;
};
...
const performCalculation = async (
  ...
  const calculationService = await import("../services/costCalculationService");
...
const CalculatorPageContent: React.FC = () => {
  ...
  const debouncedCalculate = useCallback(
      ...
      [customRates, setTargetShardName, setCurrentShardKey, setCurrentQuantity, setCurrentParams, setResult, setCalculationData]
  );
...
export const CostCalculatorPage: React.FC = () => <CalculatorPageContent />;
