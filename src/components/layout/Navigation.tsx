      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            >
              <KofiIcon className="w-3 h-3 mask-type-luminance" />
            ...
            <div className="flex flex-col space-y-1 gap-1">
              ...
              <div className="border-t border-slate-600 pt-3 my-1 space-y-1 flex flex-col gap-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3 py-2 font-medium rounded-md text-sm transition-colors duration-200 flex items-center space-x-2 cursor-pointer bg-[#FF5A16] bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/20 hover:border-amber-500/30"
                  title="Buy me a coffee"
                >
