...
export const InventoryRecipeTreeNode: React.FC<InventoryRecipeTreeNodeProps> = ({
  ...
  if (tree.method === "inventory") {
    return (
      <div className="flex items-center justify-between pl-3.5 pr-1 py-1 bg-purple-900/30 rounded-md border border-purple-500/50">
  ...
  // Handle cycle method (similar to regular RecipeTreeNode, but using InventoryRecipeTreeNode for recursion)
  if (tree.method === "cycle") {
    // Cycle implementation here - simplified for now
    return <div className="text-slate-400 text-xs">Cycle support coming soon</div>;
  }
